...
type ModalContextState = {
  ...
  locationMapVisibility: boolean;
  setLocationMapVisbility: Dispatch<SetStateAction<boolean>>;
  searchBoxQuery: null | any;
  setSearchBoxQuery: Dispatch<SetStateAction<null | any>>;
  ...
  BuyOneGetOneModal: boolean;
  setBuyOneGetOneModal: Dispatch<SetStateAction<boolean>>;
  setBuyOneGetOneModalProps: Dispatch<SetStateAction<any>>;
  buyOneGetOneModalProps: any;
};

type modalStateProps = "success" | "warning" | "error" | null;
...
export const ModalProvider = ({ children }: { children: any }) => {
  ...
  const [modalState, setModalState] = useState<modalStateProps>(null);
  ...
  const [BuyOneGetOneModal, setBuyOneGetOneModal] = useState(false);
  const [buyOneGetOneModalProps, setBuyOneGetOneModalProps] =
    useState<any>(null);
      ...
      navigator.geolocation.getCurrentPosition((position) => {
        ...
        getReverseGeoCodingApiData(
          ...
          (res) => {
            ...
            setSearchBoxQuery({
              google_address: res.google_address,
              area: res.area,
            });
  ...
  const contextValue: ModalContextState = {
    ...
    setModalMessage,
    BuyOneGetOneModal,
    setBuyOneGetOneModal,
    buyOneGetOneModalProps,
    setBuyOneGetOneModalProps,
  };
