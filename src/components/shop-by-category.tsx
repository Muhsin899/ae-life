...
const ShopByCatContent = ({
  ...
  const getTopBrandsData = useDebouncedCallback((filterPath, path) => {
  ...
  const fetchTopBrandsData = (filterPath: any, path: any) => {
    ...
    if (!topBrandsDataExists) {
      ...
      getTopBrandsData(filterPath, path);
                ...
                .map((brandData: any) => (
                  ...
                  >
                    <Image
                      ...
                      alt="brand-img"
                    />
                    <div className="absolute capitalize left-0 right-0 -bottom-5 bg-blue-200/70 text-black  w-fit mx-auto  rounded-md px-1.5 ">
                      <Typography
                        size={"xs"}
                        type="p"
                        whitespace={"nowrap"}
