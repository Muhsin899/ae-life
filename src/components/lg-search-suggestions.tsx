...
export default function LgSearchSuggestions({
  ...
  const getNoOfBrands = () => {
    return width > 1280 ? 10 : width > 991 ? 7 : width > 625 ? 5 : 6;
  };
  ...
  return (
    <div className="h-[calc(100vh_-_90px)] overflow-y-auto md:shadow-xl shadow-none md:px-3 px-1  bg-white  rounded-t-0 rounded-b-md z-50 border-t-1 border-muted space-y-3 py-2 ">
      ...
      <>
        <div className="group-search bg-white ">
          <>
            <Typography variant={"lifeText"} bold={"semibold"}>
              Trending Searches
            </Typography>
                ...
                <>
                  {suggestionsData.map((sug_data: any) => (
                    <Button
                      ...
                      variant={"normal"}
                      className="h-fit text-life py-1.5 mr-3 mt-2.5 "
                    >
                      {sug_data.query}
                    </Button>
                  ))}
        ...
        <div className="">
          ...
          <div className="grid grid-cols-2 gap-x-4 ">
            {categoriesData ? (
              ...
              <CategoriesSkeleton noOfSuggestions={6} />
            )}
          </div>
        </div>
        ...
        <div className="space-y-2">
          ...
          <div className="flex  gap-3 ">
            {brandsData ? (
              <>
                {brandsData.slice(0, getNoOfBrands()).map((brandData: any) => (
                        ...
                        <div className="flex flex-col space-y-1  ">
                          ...
                          <div className="flex space-x-2 rtl:space-x-reverse items-center">
                            ...
                            pro_data.search_offer.type ? (
                              <div className="bg-amber-200 w-fit text-[10px] py-0.5 px-2 h-fit   rounded font-semibold ">
                                {OfferType(
                                  pro_data.search_offer.type,
                                  pro_data.search_offer.label
                                )}
