    ...
    <div className="container-page  md:text-sm sm:text-xs bg-white  pb-9">
      ...
      <div>
        <div className="mx-auto  grid grid-cols-12 gap-x-5 my-2 ">
          {pro_data && (
            <>
              <div className="flex md:col-span-4 min-[570px]:col-span-6 col-span-full  rounded-lg shadow p-2 h-fit lg:flex-row md:flex-col-reverse">
              ...
              <div className="  lg:mt-0 md:col-span-5 mt-3  min-[570px]:col-span-6 col-span-full">
                  ...
                  {pro_data.categories
                    ? pro_data.categories.map((cat: any) => (
                        <Link
                          ...
                          className="bg-white border-red-600 rounded p-0.5 px-2 border text-red-600 hover:bg-red-600 hover:text-white duration-300 transition-all"
                        >
                          <Typography size={"xs"}> {cat.name}</Typography>
                        </Link>
                      ))
                    : null}
                </div>
                ...
                <div className="border-muted border rounded-lg mt-6 ">
                  ...
                  <div className=" justify-between h-fit p-3 bg-gray  sm:flex hidden ">
                    <div className="flex space-x-2.5 mr-2 items-center">
                      <Button
                        variant={"ghost"}
                        ...
                        onClick={() =>
                          proQty !== 1
                            ? setProQty((preQty: number) => preQty - 1)
                            : null
                        }
                      >
                    ...
                    <Button
                      className="w-full ltr:ml-2 rtl:mr-2"
                      onClick={() => addedToCart()}
                      iconLeft={
                        <Icon type="addToCartIcon" variant={"inputIconLeft"} />
                      }
                      rounded={"md"}
        ...
        {frequentlyBroughtData && (
          <div className="border border-muted shadow-sm rounded-lg rounded-b-none border-b-none  p-4 ">
              ...
              <div className="space-x-5   md:flex hidden ">
                <div className="space-y-1">
                  ...
                  >
                    ...
                    {frequentlyBroughtData[0].proData
                      .reduce((accumulator: any, currentProduct: any) => {
            ...
            <div className="md:space-x-5   md:hidden sm:flex block">
              <div className="space-y-1 sm:w-1/4 w-full sm:py-0 pb-3">
                <Typography
                  size={"sm"}
                  alignment={"horizontalCenter"}
                  className="text-slate-700"
        ...
        <div className="py-6 px-4 border-x border-muted shadow">
          <Typography
            size={"xxl"}
            className="text-life-2 mb-2"
            bold={"semibold"}
        ...
        <div className="lg:flex justify-around border-b border-muted py-6">
          <div className="lg:w-3/12 w-full lg:px-0 px-6 space-y-2">
            ...
            <div>
              <Typography
                ...
                size={"linkText"}
              >
                Based on {pro_data.rating.number_of_reviews} Ratings
              </Typography>
              {Array(5)
                .fill(null)
                .map((i, indx: number) => (
                  <div
                    className="bg-yellow-400 h-2 rounded-sm block mb-1"
                    style={{ width: indx * 75 }}
                  ></div>
                ))}
            </div>
      ...
      <Typography bold={"semibold"} size={"xl"} alignment={"horizontalCenter"}>
        You May Also Like
      </Typography>
