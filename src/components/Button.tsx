...
export const DeliverInstructionsBtn = ({ instr }: { instr: any }) => {
  ...
  return (
    <button
      ...
      className={`border  p-2 rounded-lg shadow shadow-slate-100 ${
...
export const AddOrEditCartBtn = ({
  ...
  return proQty > 0 || loadingFinished || isSingleProductPage ? (
    <div className="flex items-center">
      ...
      <Typography size={"sm"} bold={"bold"} className="sm:px-2.5 px-2 flex items-center">
...
export const BorderInputField = (props: inputProps) => {
  return (
    <div className="border border-[#39f] rounded-lg px-3  w-full relative">
      <div className="px-2 bg-white  w-fit absolute -top-2">
        <Typography size={"xs"} variant={"lifeText"} bold={"bold"}>
          {props.label}
        </Typography>
      </div>
      {props.description}
