...
const LgNavbarCategoriesSection = ({
  ...
  return (
    <div className="bg-white md:block hidden shadow-sm">
      <NavigationMenu.Root className="container-page relative flex ltr:justify-between rtl:justify-end">
        <NavigationMenu.List
        ...
        >
          ...
          >
            <NavigationMenu.Trigger
              className={`${
                groupHoverState ? "bg-primary text-white " : "text-black"
        ...
        <div className=" absolute top-full left-0 right-0 flex w-full justify-center mx-[10px]">
