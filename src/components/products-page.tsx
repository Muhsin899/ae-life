            ...
            ? categoryData.brand_details.short_description && (
                <div className="relative">
                  <p
                    className={cn(
                      ` my-5 ${
                        readMoreClick ? "" : "overflow-y-hidden h-[4rem]"
                      } text-ellipsis !leading-7`,
                      typographyVariants({ bold: "light", size: "linkText" })
                    )}
                  ...
                  >
                    <button
                      ...
                      className=" rounded-full font-[500] text-xs bg-white border border-muted hover:bg-slate-100 hover:text-blue-500 p-0.5 px-2"
                    >
